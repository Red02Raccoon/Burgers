...
gulp.task('browser-sync', ['html', 'styles', 'images', 'fonts', 'build:js', 'vendor:js', 'vendor:css', 'php'], function() {
  browserSync.init({
    server: {
      baseDir: "./dist"
    }
...
gulp.task('build', function(cb) {
  runSequence(
    ['clean'], ['html', 'styles', 'images', 'fonts', 'build:js', 'vendor:js', 'vendor:css', 'php'],
    cb
  );
});
